...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
            <form class="box-20" method="POST" action="{{ url('admin/collection/store')}}">
            <h5>Collection Entry <span class="right">Total Collection: <strong>{{$total}}</strong></span></h5>
            <hr>
            @csrf
        ...
        $(document).ready(function()
        {
            var dTable = $('#roles_table').DataTable({
                ...
                createdRow: function ( row, data, index ) {
                    ...
                    $('td', row).eq(0).attr('title', 'Click to edit Name');
                    $('td', row).eq(1).attr('title', 'Click to edit Contact');
            ...
            function update(updatedCell, updatedRow, oldValue) 
            {
                ...
                var contact_no = updatedRow.data().contact_no;
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        updatedRow.data().contact_no = data.contact_no;
